...
SOURCE = SOURCES["bodybuilding"]

SOURCE_NAME = SOURCE["name"]

BASE_URL = SOURCE["url"]

NEWS_URL = "https://shop.bodybuilding.com/pages/all-stories"
...
def find_articles(soup):
    """
    Localiza apenas os links que podem
    representar artigos.
    """
...
# ============================================
# EXTRAÇÃO DOS LINKS DOS ARTIGOS
# ============================================
...
def create_article_soup(response):
    """
    Cria o BeautifulSoup de um artigo.
    """
...
def collect_news():
    ...
    na página principal do Bodybuilding.com.
    """
...
def run():
    """
    Executa o coletor do Bodybuilding.com.
...
# pela coleta de notícias do Bodybuilding.com.
#
# Responsabilidades:
#
